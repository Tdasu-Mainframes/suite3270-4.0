...
[Setup]
AllowNoIcons=yes
AppCopyright=Copyright (C) 1989-2020 by Paul Mattes, GTRC and others
AppName=wc3270
AppPublisher=Paul Mattes
AppPublisherURL=http://x3270.bgp.nu
AppSupportURL=http://x3270.bgp.nu
AppUpdatesURL=http://x3270.bgp.nu
AppVerName=wc3270 4.0ga11
ArchitecturesInstallIn64BitMode=x64
ChangesAssociations=yes
Compression=lzma
DefaultDirName={commonpf}\wc3270
DefaultGroupName=wc3270
DisableDirPage=no
MinVersion=0,6.0
OutputBaseFilename=wc3270-4.0ga11-setup
OutputDir=.
SolidCompression=yes
WizardSmallImageFile=wc3270\x3270-icon2.bmp
...
Name: "s3270"; Description: "s3270 (scripting app)"; Types: full custom
...
; Get rid of the old pre-4.0 HTML directory.
...
Source: "obj\win32\wc3270\c3270.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: not Is64BitInstallMode
...
Source: "obj\win64\ws3270\ws3270.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: Is64BitInstallMode; Components: s3270
Source: "obj\win64\ws3270\s3270.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: Is64BitInstallMode; Components: s3270
Source: "obj\win32\wpr3287\wpr3287.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: not Is64BitInstallMode
Source: "obj\win32\wpr3287\pr3287.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: not Is64BitInstallMode
...
Source: "obj\win32\x3270if\x3270if.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: not Is64BitInstallMode
Source: "obj\win64\x3270if\x3270if.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: Is64BitInstallMode
Source: "wc3270\LICENSE.txt"; DestDir: "{app}"; Flags: ignoreversion
...
begin
; result := '/c start /b http://x3270.bgp.nu/wc3270-help/4.0ga11/'
 result := '/c start http://x3270.bgp.nu/wc3270-help/4.0ga11/'
end;
